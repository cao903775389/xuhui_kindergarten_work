  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    :root {
      ...
      --app-bg: linear-gradient(180deg, #f8fafc 0%, #f3f6fa 100%);
      --sidebar-bg: linear-gradient(180deg, #ffffff 0%, #f1f4f8 100%);
      --brand-bg: linear-gradient(180deg, #ffffff 0%, rgba(255, 255, 255, 0.62) 100%);
      --brand-border: rgba(15, 23, 42, 0.14);
      --page-head-bg:
        linear-gradient(180deg, #ffffff 0%, rgba(255, 255, 255, 0.76) 100%);
      --section-bg: #ffffff;
      --card-bg: #ffffff;
      --metric-bg: #f8fafc;
      --table-bg: #ffffff;
    ...
    .side-module.active {
      ...
      border-color: var(--cyan-border);
      color: var(--blue);
      box-shadow: inset 0 1px 0 rgba(15, 23, 42, 0.024);
    }
    .side-module.active strong {
      color: var(--blue);
    }
...
${renderFamilyConstraintSelector()}
    ...
    <section id="architecture" data-module-section="sources">
      <div class="section-title">
        <h2>架构与数据流</h2>
...
${renderDistrictCapacityOverview()}
    ...
    <section id="sources" data-module-section="sources">
      <div class="section-title">
        <h2>风险与来源</h2>
  ...
  <script>
    ...
    function setActiveModule(moduleName, pushHash = true) {
      ...
      for (const section of moduleSections) {
        section.hidden = section.dataset.moduleSection !== nextModule;
      }
    ...
    const moduleFromHash = () => {
      ...
      if (hash === "data" || hash === "query" || hash === "areas") return "data";
      if (hash === "rent-page" || hash === "rent") return "rent";
      if (hash === "sources-page" || hash === "sources" || hash === "modules" || hash === "architecture") return "sources";
      return "strategy";
    };
